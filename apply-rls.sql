...
-- 4. PROFILES POLICIES
-- ==============================================================================
CREATE POLICY "Profiles SELECT" ON profiles FOR SELECT TO authenticated USING (id = (select auth.uid()) OR get_user_role() IN ('admin', 'manager'));
...
-- ROOMS
CREATE POLICY "rooms_select" ON rooms FOR SELECT TO authenticated USING (get_user_role() IN ('admin', 'manager', 'employee'));
CREATE POLICY "rooms_insert" ON rooms FOR INSERT TO authenticated WITH CHECK (get_user_role() IN ('admin', 'manager', 'employee'));
CREATE POLICY "rooms_update" ON rooms FOR UPDATE TO authenticated USING (get_user_role() IN ('admin', 'manager'));
...
-- BILLING HISTORY
CREATE POLICY "billing_history_select" ON billing_history FOR SELECT TO authenticated USING (get_user_role() IN ('admin', 'manager', 'employee'));
CREATE POLICY "billing_history_insert" ON billing_history FOR INSERT TO authenticated WITH CHECK (get_user_role() IN ('admin', 'manager', 'employee'));
CREATE POLICY "billing_history_update" ON billing_history FOR UPDATE TO authenticated USING (get_user_role() IN ('admin', 'manager'));
...
-- EVENTS
CREATE POLICY "events_select" ON events FOR SELECT TO authenticated USING (get_user_role() IN ('admin', 'manager', 'employee'));
CREATE POLICY "events_insert" ON events FOR INSERT TO authenticated WITH CHECK (get_user_role() IN ('admin', 'manager', 'employee'));
CREATE POLICY "events_update" ON events FOR UPDATE TO authenticated USING (get_user_role() IN ('admin', 'manager'));
CREATE POLICY "events_delete" ON events FOR DELETE TO authenticated USING (get_user_role() = 'admin');

-- ROOM STATUS OVERRIDES
CREATE POLICY "room_status_overrides_select" ON room_status_overrides FOR SELECT TO authenticated USING (get_user_role() IN ('admin', 'manager', 'employee'));
CREATE POLICY "room_status_overrides_insert" ON room_status_overrides FOR INSERT TO authenticated WITH CHECK (get_user_role() IN ('admin', 'manager', 'employee'));
CREATE POLICY "room_status_overrides_update" ON room_status_overrides FOR UPDATE TO authenticated USING (get_user_role() IN ('admin', 'manager'));
...
-- ==============================================================================
CREATE POLICY "menu_items_select" ON menu_items FOR SELECT TO authenticated USING (get_user_role() IN ('admin', 'manager', 'employee'));
CREATE POLICY "menu_items_insert" ON menu_items FOR INSERT TO authenticated WITH CHECK (get_user_role() IN ('admin', 'manager'));
CREATE POLICY "menu_items_update" ON menu_items FOR UPDATE TO authenticated USING (get_user_role() IN ('admin', 'manager'));
